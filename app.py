...
app = Flask(__name__)
app.secret_key = '1234'
Database.initialise(host='localhost', database='learning', user='postgres', password='Hellfish3')


# Creates a user object g that is available globally to all methods
@app.before_request
def load_user():
...
def search():
    ...
    return render_template('search.html', content=tweet_texts, search=query)
